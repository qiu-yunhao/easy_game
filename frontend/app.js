...
function syncControlsFromState(state = latestState) {
  ...
  startSceneButton.disabled = isBusy || autoActive;
  restartSceneButton.disabled = isBusy || autoActive;
  ...
  loadPlayerButton.disabled = isBusy || autoActive || !persistenceReady || !selectedPlayerId;
  newGameButton.disabled = isBusy || autoActive || !persistenceReady;
  saveGameButton.disabled = isBusy || autoActive || !persistenceReady || !currentPlayerId;
